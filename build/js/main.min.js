...
class TabController {
  constructor(container) {
    ...
    this.tabpanels = this.container.querySelectorAll(".tab-section__content-item");
...
window.$ = (jquery__WEBPACK_IMPORTED_MODULE_0___default()); // import Swiper from "swiper/bundle";
...
__webpack_require__(/*! ../js/modules/read-more */ "./js/modules/read-more.js");
...
if (menuButton) {
  menuButton.addEventListener("click", () => {
    ...
    lang.classList.toggle("lang--active"); // playBtn.classList.toggle("volume__button--active");
...
document.addEventListener("DOMContentLoaded", () => {
  __webpack_require__(/*! ../../../../../../../js/modules/tab-section */ "./js/modules/tab-section.js"); // Слайдер на главной


  const mainSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".promo-slider .swiper", {
    effect: "coverflow",
    grabCursor: true,
    centeredSlides: true,
    slidesPerView: "auto",
  ...
  const sectionSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".section__slider.swiper", {
    effect: "coverflow",
    grabCursor: true,
    centeredSlides: true,
    slidesPerView: "auto",
  ...
  if (mapTabs) {
    mapTabs.forEach(tab => {
      tab.addEventListener("click", function () {
        //Слайдр для карт
        const swiperMap = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".map__slider", {
          effect: "fade",
          navigation: {
            nextEl: ".swiper-button-next",
            prevEl: ".swiper-button-prev"
  ...
  const swiperGallery = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".swiper-gallery", {
    effect: "coverflow",
    spaceBetween: 10,
    grabCursor: true,
    centeredSlides: true,
    ...
    slideToClickedSlide: true // thumbs: {
    //   swiper: swiperThumbs,
    // },

  }); //Слайдр с фейдом на лендиге

  const sectionFadeSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".swiper-fade-slider", {
    effect: "fade",
    fadeEffect: {
      crossFade: true
    },
  ...
  const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".textpage__slider", {
    slidesPerView: "auto",
    centeredSlides: true,
    spaceBetween: 30,
    pagination: {
  ...
  var $items = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".map__img");
  var $description = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".description__item");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".btn-group").on("click", ".filter", function () {
    ...
    // }).addClass(value);
    var value = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data("filter");
    $items.removeClass("active");
    $items.not($selected).removeClass("active");
    var $selected = $items.filter(function () {
      return jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data("filter").indexOf(value) != -1;
    }).addClass("active");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass("active").siblings().removeClass("active");
    $description.removeClass("active");
    var $selectedDescr = $description.filter(function () {
      return jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data("filter").indexOf(value) != -1;
    }).fadeIn();
